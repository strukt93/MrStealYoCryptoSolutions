...
export interface BaseLaunchpegNFTInterface extends utils.Interface {
  functions: {
...
export interface BaseLaunchpegNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseLaunchpegNFTInterface;
