...
export interface OptionsContractInterface extends utils.Interface {
  functions: {
    ...
    "createAndSellERC20CollateralOption(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "createAndSellERC20CollateralOption",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export interface OptionsContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptionsContractInterface;
  ...
  functions: {
    ...
    createAndSellERC20CollateralOption(
      amtCollateral: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
