...
export interface LockManagerInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "numLocks", values?: undefined): string;
...
export interface LockManager extends BaseContract {
  ...
  functions: {
    ...
    numLocks(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    numLocks(overrides?: CallOverrides): Promise<PopulatedTransaction>;
