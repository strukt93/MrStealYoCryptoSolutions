...
export interface EminenceCurrencyInterface extends utils.Interface {
  functions: {
    "CURVE()": FunctionFragment;
    "EMN()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "EMN", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "EMN", data: BytesLike): Result;
...
export interface EminenceCurrency extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EminenceCurrencyInterface;
  ...
  functions: {
    ...
    EMN(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    EMN(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    EMN(overrides?: CallOverrides): Promise<PopulatedTransaction>;
